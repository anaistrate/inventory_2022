...
if __name__ == '__main__':
  ...
  parser.add_argument('--input-file', type=str, default='data/manual_classifications.csv', help = 'Location of the input file')
  parser.add_argument('--train-file', type=str, default='data/train_paper_classif.csv', help = 'Location where the training file will be saved')
  parser.add_argument('--val-file', type=str, default='data/val_paper_classif.csv', help = 'Location where the val file will be saved')
  parser.add_argument('--test-file', type=str, default='data/test_paper_classif.csv', help = 'Location where the test file will be saved')
