...
if __name__ == '__main__':
  ...
  data_handler = DataHandler(model_huggingface_version, args.train_file, args.val_file, args.test_file)
  ...
  checkpt_filename = args.output_dir + 'checkpt_paper_classif_' + args.model_name + '_' + str(best_epoch + 1) + '_epochs'
  trainer.save_best_model(checkpt_filename)
  print('Saved best checkpt to', checkpt_filename)

  # Plot losses
  img_filename = args.output_dir + 'paper_classif_' + args.model_name + '_' + str(best_epoch + 1) + '_epochs.png'
